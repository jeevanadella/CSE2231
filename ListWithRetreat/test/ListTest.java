...
public abstract class ListTest {
    ...
    /**
     * test retreat once when size 2.
     */
    @Test
    public void testRetreatOnceTwo() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "red", "orange");
        List<String> list2 = this.createFromArgsRef(0, "red", "orange");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    /**
     * test retreat once when size 3.
     */
    @Test
    public void testRetreatOnceThree() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "red", "orange",
                "yellow");
        List<String> list2 = this.createFromArgsRef(1, "red", "orange",
                "yellow");
        /*
         * Call method under test
         */
    ...
    /**
     * test retreat twice when size 3.
     */
    @Test
    public void testRetreatTwiceThree() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "red", "orange",
    ...
    /**
     * test retreat thrice when size 7.
     */
    @Test
    public void testRetreatThriceSeven() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(7, "red", "orange",
                "yellow", "green", "blue", "indigo", "violet");
        List<String> list2 = this.createFromArgsRef(4, "red", "orange",
                "yellow", "green", "blue", "indigo", "violet");
        /*
         * Call method under test
         */
