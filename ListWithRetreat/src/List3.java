...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        //n alias of lastLeft
        Node n = this.lastLeft;

        //setting the next node to be lastLeft previous next
        p.next = n.next;
        //setting previous to be lastLeft
        p.previous = n;
        //setting the original lastLeft's next's previous to be p
        n.next.previous = p;
        //setting lastLeft's next to be p
        n.next = p;
        //adding to right length
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        //n alias for lastLeft next
        Node n = this.lastLeft.next;
        T x = n.data;

        //changing lastLeft next
        this.lastLeft.next = n.next;
        //changing n next previous to lastLeft
        n.next.previous = this.lastLeft;

        //accounting for change in lengths
        this.rightLength--;
    ...
    public final void advance() {
        ...
        //setting last left to be the previous next
    ...
    public final void moveToStart() {
        //using smart node to set lastLeft equal to the first real node
        this.lastLeft = this.preStart;
        //accounting for change in lengths
    ...
    public final void moveToFinish() {
        ...
        //changing the lastLeft to the last real node(non-smart)
    ...
    public final void retreat() {
        ...
        // changing the lastLeft to the previous node
        this.lastLeft = this.lastLeft.previous;
        // accounting for the change in lengths
        this.rightLength++;
        this.leftLength--;
