...
public class Program2 extends ProgramSecondary {
    ...
    public final Map<String, Statement> newContext() {
        ...
        // creates and returns new representation of String-Statement Map
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // stores value of c
        Map<String, Statement> m = c.newInstance();
        m.transferFrom(c);

        c.transferFrom(this.context);

        // swaps after creating representation of each
        this.context.transferFrom(m);
    ...
    public final Statement newBody() {
        ...
        // creates and returns new representation of body
    ...
    public final void swapBody(Statement b) {
        ...
        // stores value of b
        Statement s = b.newInstance();
        s.transferFrom(b);

        b.transferFrom(this.body);

        // swaps after creating representations of each
        this.body.transferFrom(s);
